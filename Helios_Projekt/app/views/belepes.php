...
if (isset($_SESSION['userid'])) {
    if ($_SESSION['userlevel'] == '001') { // Jogosultság ellenőrzése
        echo "Bejelentkezve vagy admin jogosultsággal.";
    } else {
        echo "Bejelentkezve vagy felhasználó jogosultsággal.";
    }
} else {
...
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh;">
    ...
    <br><br>
    <p>
        <a href="http://localhost/Helios_Projekt/public/index.php?url=regist">Szeretne regisztrálni?</a>
    </p>
</div>
